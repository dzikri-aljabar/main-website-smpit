                    ...
                    <div class="mt-3 flex justify-between">
                        ...
                        <div>
                            <span
                                ...
                                <p class="text-sm whitespace-nowrap">Berita</p>
                            </span>
                        </div>
                    </div>
                </header>
            ...
            <div id="sidebar" class="basis-1/4">
                <div class=" sticky top-5">
                    <div class="shadow-[0px_0px_20px_-6px_#e3e3e3] rounded-lg p-4 mb-4">
                        ...
                        <img src="https://smpitcahayainsanii.sch.id/wp-content/uploads/2022/10/WhatsApp-Image-2023-10-02-at-08.16.38.jpeg"
                            alt="">
                        ...
                        <a href="#" class="bg-[#FF5700] text-center py-2 text-white w-full block">Daftar
                            Sekarang</a>
                    </div>
                        ...
                        <ul class="space-y-4">
                            @foreach ($beritas as $item)
                                <li class="overflow-hidden">
                                    ...
                                    <a href="http://127.0.0.1:8000/berita/{{ $item->slug }}"
